...
export const metadata: Metadata = {
    ...
    description: 'Browse the complete sitemap of Snake Clash. Find every page on our website including games, blog posts, and information pages.',
    keywords: ['Snake Clash sitemap', 'all pages', 'site navigation'],
    alternates: {
...
const sections = [
    {
        ...
        links: [
            { href: '/', label: 'Home' },
            { href: '/play', label: 'Play Snake Clash' },
    ...
    },
    {
        ...
        links: [
            ...
            { href: '/blog/what-is-jigsolitaire', label: 'What is Snake Clash?' },
        ...
        <>
            <div className="page-header">
                <div className="container">
                    ...
                    <p>Browse every page on Snake Clash.</p>
                </div>
            </div>
