...
export const metadata: Metadata = {
    title: 'Cookie Policy',
    description: 'Learn about the cookies Snake Clash uses, why we use them, and how to manage your cookie preferences.',
    keywords: ['Snake Clash cookies', 'cookie policy', 'cookie preferences', 'tracking cookies'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    This Cookie Policy explains what cookies are, how Snake Clash uses them, and how you can
                ...
                <p>Snake Clash uses cookies for the following purposes:</p>
                ...
                <p>
                    We currently do not use any tracking or analytics cookies (such as Google Analytics) on Snake Clash.
                </p>
                ...
                <p>
                    ...
                    or email <strong>privacy@snakeclash.site</strong>.
                </p>
            </div>
        </>
    );
