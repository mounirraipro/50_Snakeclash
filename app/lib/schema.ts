...
const SITE_URL = 'https://snakeclash.site';
...
export function buildWebSiteSchema() {
    return {
        ...
        name: 'Snake Clash',
        url: SITE_URL,
        description: 'Play Snake Clash free online — no download, no account needed.',
        potentialAction: {
            '@type': 'SearchAction',
            target: {
                '@type': 'EntryPoint',
...
export function buildWebApplicationSchema() {
    return {
        ...
        description:
            'A free browser-based game. Play Snake Clash online instantly.',
        author: {
            '@type': 'Person',
            name: AUTHOR_NAME,
            url: AUTHOR_URL,
