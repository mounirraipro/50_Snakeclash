...
export const metadata: Metadata = {
    ...
    description: 'Snake Clash is committed to digital accessibility. Learn about our efforts to make our game available to everyone.',
    keywords: ['Snake Clash accessibility', 'accessible game', 'web accessibility statement'],
};
        ...
        <>
            <div className="page-header">
                <div className="container">
                    ...
                    <p>Our commitment to making Snake Clash accessible to everyone.</p>
                </div>
            </div>

            <div className="page-content">
                <p>
                    Snake Clash is committed to ensuring digital accessibility for people with disabilities.
                ...
                <p>
                    We recognize that the game component of Snake Clash presents additional accessibility
                ...
                <h2>Feedback</h2>
                <p>
                    We welcome your feedback on the accessibility of Snake Clash. If you encounter
                ...
                <ul>
                    ...
                    <li>Email: <strong>accessibility@snakeclash.site</strong></li>
                </ul>
                <p>
