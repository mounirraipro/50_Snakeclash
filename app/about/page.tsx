...
const aboutSchema = [
    {
        ...
        '@type': 'AboutPage',
        name: 'About Snake Clash',
        url: 'https://snakeclash.site/about',
        description: 'Learn about Snake Clash, our mission, and the team behind the game.',
        publisher: {
            '@type': 'Organization',
            name: 'Snake Clash',
...
export const metadata: Metadata = {
    title: 'About Us – Snake Clash',
    description: 'Learn about Snake Clash, our mission, and the team behind the game.',
    keywords: ['about Snake Clash', 'game team', 'who made Snake Clash'],
};
        ...
        <>
            ...
            <div className="page-header">
                <div className="container">
                    <h1 className="gradient-text">About Snake Clash</h1>
            ...
            <div className="page-content">
                <h2>Our Story</h2>
                <p>
                    Snake Clash was born from a simple idea: what if playing Snake Clash could be even simpler and more accessible?. The result is a game
                    that&apos;s instantly intuitive yet endlessly engaging — an experience unlike any other on the web.
                </p>
                <p>
                    We launched Snake Clash with a clear vision — to create a free, accessible, and
                    ...
                    Snake Clash has something for you.
                </p>
                ...
                <p>
                    Every level in Snake Clash is handcrafted with care. We obsess over the details
                    so you can simply enjoy the game.
                </p>

                <h2>What Makes Us Different</h2>
                <p>
                    Snake Clash offers a unique experience compared to similar games in its category.
                </p>
                ...
                <p>
                    ...
                    <a href="/contact">Contact page</a>. Your input helps us make Snake Clash better for
                    everyone.
                </p>
            </div>
        </>
