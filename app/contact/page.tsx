...
const SUPPORT_EMAIL = 'hello@snakeclash.site';

export const metadata: Metadata = {
    title: 'Contact Snake Clash',
    description: 'Get in touch with the Snake Clash team for support, feedback, partnerships, accessibility concerns, or privacy questions.',
    keywords: ['contact Snake Clash', 'Snake Clash support', 'game contact'],
    alternates: {
        canonical: '/contact',
    },
};
