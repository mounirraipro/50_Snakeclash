...
export const metadata: Metadata = {
    ...
    description: 'Read the Snake Clash Terms of Service. Understand the rules and guidelines for using our free online game.',
    keywords: ['Snake Clash terms of service', 'terms and conditions', 'usage agreement'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    Welcome to Snake Clash. By accessing or using our website and game, you agree to be
                    bound by these Terms of Service. Please read them carefully before using our services.
                </p>

                <h2>1. Acceptance of Terms</h2>
                <p>
                    By accessing Snake Clash at snakeclash.site, you acknowledge that you have read,
                ...
                <p>
                    Snake Clash provides a free, browser-based game. Snake Clash is a free, browser-based game experience.
                    The service includes the game itself, educational content, blog articles, and related resources.
                </p>

                <h2>3. User Eligibility</h2>
                <p>
                    Snake Clash is available to users of all ages. However, users under 13 years of age
                ...
                <p>
                    All content on Snake Clash — including but not limited to the game design, code, images,
                    text, graphics, logos, and audio — is the intellectual property of Snake Clash or its
                ...
                <p>
                    ...
                    Snake Clash for personal, non-commercial purposes only.
                </p>

                <h2>5. Acceptable Use</h2>
                <p>When using Snake Clash, you agree NOT to:</p>
                <ul>
                ...
                <p>
                    ...
                    grant Snake Clash a non-exclusive, royalty-free, perpetual license to use, modify,
                    and incorporate that content into our services.
                </p>

                <h2>7. Advertisements</h2>
                <p>
                    Snake Clash displays advertisements from third-party ad networks, including Google
                ...
                <p>
                    Snake Clash is provided &ldquo;as is&rdquo; and &ldquo;as available&rdquo; without warranties of any
                ...
                <p>
                    To the fullest extent permitted by law, Snake Clash and its operators shall not be
                ...
                <p>
                    We reserve the right to suspend or terminate your access to Snake Clash at our sole
                ...
                <p>
                    ...
                    <strong>legal@snakeclash.site</strong>.
                </p>
            </div>
        </>
    );
