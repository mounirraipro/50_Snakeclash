...
export const metadata: Metadata = {
    ...
    description: 'Read the Snake Clash Privacy Policy. Learn how we collect, use, and protect your personal data when you use our free online game.',
    keywords: ['Snake Clash privacy policy', 'data protection', 'cookie policy'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    At Snake Clash, we are committed to protecting your privacy and ensuring transparency
                ...
                <ul>
                    ...
                    <li>To protect the rights, property, or safety of Snake Clash, our users, or the public</li>
                </ul>

                <h2>5. Children&apos;s Privacy</h2>
                <p>
                    Snake Clash is designed to be family-friendly. We do not knowingly collect personal
                ...
                <p>
                    ...
                    <strong>privacy@snakeclash.site</strong>.
                </p>
            </div>
        </>
    );
